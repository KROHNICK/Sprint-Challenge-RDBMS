...
RDMS is the system the data is on, SQL is the language we use to work on the system.

1. Why do tables need a `primary key`?

They identify the columns with calues that uniquley identify a row in a table.
...
Primary key, foreign key, relationshipd between ID fields in the table.
